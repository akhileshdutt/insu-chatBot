...
# # --- Constants and Paths ---
# BASE_PATH = r"D:\BajajPy"  # Change if your base folder is different
...
# # --- Load .env from current directory for local dev ---
# load_dotenv()  # This looks for a .env file in the current working directory (where you run uvicorn)

# # --- Constants and Paths ---
# BASE_PATH = os.getenv('BASE_PATH', r"D:\BajajPy")  # Can override in env vars as needed
# PARSED_TEXT_OUTPUT_FOLDER = os.path.join(BASE_PATH, "Parsed_text")
# FAISS_INDEX_OUTPUT_FOLDER = os.path.join(BASE_PATH, "faiss_index")
# AGGREGATED_CHUNKS_FILENAME = 'all_policy_chunks.jsonl'
# FAISS_INDEX_FILENAME = 'policy_chunks_faiss_index.bin'
